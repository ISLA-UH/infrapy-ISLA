...
class IPWaveformSelectorWidget(QWidget):
    ...
    def buildUI(self):
        ...
        tooltip_text = 'Select which waveforms to show/hide with the checkbox on the left. Remove the waveforms ' \
                       'from the plot with the buttons on the right.'
    ...
    def update_selections(self, new_stream: Optional[Stream]):
        """
        This is called when waveforms are added or removed and updates the items in the checkbox list
        ...
        :param new_stream: new obspy stream with traces to display
        """
    ...
    @pyqtSlot(int)
    def del_button_clicked(self, id: int):
        """
    ...
    @pyqtSlot(int)
    def update_what_is_displayed(self, id: int):
        """
        update display
    ...
    def get_checkbox_list(self) -> list:
        """
