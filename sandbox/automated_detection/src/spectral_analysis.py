...
def spectral_detection(stream, freq_range, mortlet_omega0, spec_overlap, p_val, threshold_window, threshold_overlap,
                       clustering_freq_dist, clustering_eps, clustering_min_samples, file_out, fig_out):
...
if __name__ == '__main__':
    ...
    #     Define Parameters     #
    # ######################### #
    data_file = obspy.read("examples/data/YJ.BRP1..EDF.SAC")
    ...
    file_out = "examples/output/test.json"
    fig_out = "examples/output/test.png"

    spectral_detection(data_file, [freq_min, freq_max], 14, spec_overlap, p_val, threshold_window, threshold_overlap,
                    clustering_freq_dist, clustering_eps, clustering_min_samples, file_out, fig_out)
